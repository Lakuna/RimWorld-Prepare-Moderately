...
namespace PrepareModerately {
	...
	public class ButtonPatch {
		...
		public static void Postfix(Rect rect, Page_ConfigureStartingPawns __instance) {
			...
			try { Find.WindowStack.Add(PrepareModerately.Instance.page); } catch (Exception e) { Log.Warning("Failed to make window for Prepare Moderately (unexpected exception).\n" + e.StackTrace); }
		}
	}
}
